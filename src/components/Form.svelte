                         ...
                         <div class="border-b border-gray-900/10 pb-12">
                              ...
                              <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                   <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                             <input type="text" on:input={ (event) => { validateForm("from-address", "from", "street", event) } } value={ invoice?.billFromAddress?.street } name="from-street-address" id="from-street-address" autocomplete="street-address" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                   ...
                                   <div class="sm:col-span-2 sm:col-start-1">
                                        ...
                                        <div class="mt-2">
                                             <input type="text" on:input={ (event) => { validateForm("from-city", "from", "city", event) } } value={ invoice?.billFromAddress?.city } name="city" id="city" autocomplete="address-level2" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                   ...
                                   <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2">
                                             <input type="text" on:input={ (event) => { validateForm("from-zip", "from", "zip", event) } } value={ invoice?.billFromAddress?.zip } maxlength="5" name="postal-code" id="postal-code" autocomplete="postal-code" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                         ...
                         <div class="border-b border-gray-900/10 pb-12">
                              ...
                              <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                   <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                             <input type="text" on:input={ (event) => { validateForm("to-name", "to", "name", event) } } value={ invoice?.billToAddress?.name } name="name" id="name" autocomplete="given-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                   ...
                                   <div class="sm:col-span-4">
                                        ...
                                        <div class="mt-2">
                                             <input id="email" on:input={ (event) => { validateForm("to-email", "to", "email", event) } } value={ invoice?.billToAddress?.email } name="email" type="email" autocomplete="email" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                   ...
                                   <div class="sm:col-span-2 sm:col-start-1">
                                        <label for="city" class="block text-sm font-medium leading-6 text-gray-900">City</label>
                                        <div class="mt-2">
                                             <input type="text" on:input={ (event) => { validateForm("to-city", "to", "city", event) } } value={ invoice?.billToAddress?.city } name="city" id="city" autocomplete="address-level2" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                   ...
                                   <div class="sm:col-span-2">
                                        <label for="postal-code" class="block text-sm font-medium leading-6 text-gray-900">ZIP / Postal code</label>
                                        <div class="mt-2">
                                             <input type="text" on:input={ (event) => { validateForm("to-zip", "to", "zip", event) } } value={ invoice?.billToAddress?.zip } maxlength="5" name="postal-code" id="postal-code" autocomplete="postal-code" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                              ...
                              <div>
                                   ...
                                   <div class="mt-2">
                                        <input type="text" on:input={ (event) => { validateForm("to-description", "to", "description", event) } } value={ invoice?.billToAddress?.description } name="description" id="description" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                   </div>
                                   ...
                                   <div class="mt-2 space-y-4">
                                        {#each invoice.billToAddress.items as item, i}
                                             <div class="flex items-center space-x-4">
                                                  <input type="text" on:input={ (event) => { validateForm("item-name", false, false, event) } } value={ item?.name } class="block w-full bg-transparent rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="e.g. ToDo">
                                                  <input type="text" on:input={ (event) => { validateForm("item-qty", false, false, event) } } value={ item?.qty } class="block w-full bg-transparent rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="e.g. ToDo">
                                                  <input type="text" on:input={ (event) => { validateForm("item-price", false, false, event) } } value={ item?.price } class="block w-full bg-transparent rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="e.g. ToDo">
                                             </div>
                                        {/each}
               ...
               <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                         <div class="col-span-full">
                              <label for="from-street-address" class="block text-sm font-medium leading-6 text-gray-900">Street address</label>
                              <div class="mt-2">
                                   <input type="text" on:input={ (event) => { validateForm("from-address", "from", "street", event) } } bind:value={ formFields.from.street } name="from-street-address" id="from-street-address" autocomplete="street-address" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                              </div>
                              <p class="text-red-500">{errors.from.street}</p>
                         </div>
                         ...
                         <div class="sm:col-span-2 sm:col-start-1">
                              <label for="city" class="block text-sm font-medium leading-6 text-gray-900">City</label>
                              <div class="mt-2">
                                   <input type="text" on:input={ (event) => { validateForm("from-city", "from", "city", event) } } bind:value={ formFields.from.city } name="city" id="city" autocomplete="address-level2" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                              </div>
                              <p class="text-red-500">{errors.from.city}</p>
                         </div>
                         ...
                         <div class="sm:col-span-2">
                              <label for="postal-code" class="block text-sm font-medium leading-6 text-gray-900">ZIP / Postal code</label>
                              <div class="mt-2">
                                   <input type="text" on:input={ (event) => { validateForm("from-zip", "from", "zip", event) } } bind:value={ formFields.from.zip } maxlength="5" name="postal-code" id="postal-code" autocomplete="postal-code" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                              </div>
                              <p class="text-red-500">{errors.from.zip}</p>
                         </div>
                    </div>
               ...
               <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                         <div class="sm:col-span-3">
                              <label for="name" class="block text-sm font-medium leading-6 text-gray-900">Client's name</label>
                              <div class="mt-2">
                                   <input type="text" on:input={ (event) => { validateForm("to-name", "to", "name", event) } } bind:value={ formFields.to.name } name="name" id="name" autocomplete="given-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                              </div>
                              <p class="text-red-500">{errors.to.name}</p>
                         </div>
                         ...
                         <div class="sm:col-span-4">
                              <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Email address</label>
                              <div class="mt-2">
                                   <input id="email" on:input={ (event) => { validateForm("to-email", "to", "email", event) } } bind:value={ formFields.to.email } name="email" type="email" autocomplete="email" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                              </div>
                              <p class="text-red-500">{errors.to.email}</p>
                         </div>
                         ...
                         <div class="col-span-full">
                              <label for="street-address" class="block text-sm font-medium leading-6 text-gray-900">Street address</label>
                              <div class="mt-2">
                                   <input type="text" on:input={ (event) => { validateForm("to-street", "to", "street", event) } } bind:value={ formFields.to.street } name="street-address" id="street-address" autocomplete="street-address" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                              </div>
                              <p class="text-red-500">{errors.to.street}</p>
                         </div>
                         ...
                         <div class="sm:col-span-2 sm:col-start-1">
                              <label for="city" class="block text-sm font-medium leading-6 text-gray-900">City</label>
                              <div class="mt-2">
                                   <input type="text" on:input={ (event) => { validateForm("to-city", "to", "city", event) } } bind:value={ formFields.to.city } name="city" id="city" autocomplete="address-level2" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                              </div>
                              <p class="text-red-500">{errors.to.city}</p>
                         </div>
                         ...
                         <div class="sm:col-span-2">
                              <label for="postal-code" class="block text-sm font-medium leading-6 text-gray-900">ZIP / Postal code</label>
                              <div class="mt-2">
                                   <input type="text" on:input={ (event) => { validateForm("to-zip", "to", "zip", event) } } bind:value={ formFields.to.zip } maxlength="5" name="postal-code" id="postal-code" autocomplete="postal-code" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                              </div>
                              <p class="text-red-500">{errors.to.zip}</p>
                         </div>
                    </div>
                    ...
                    <div>
                         <label for="description" class="block text-sm font-medium leading-6 text-gray-900">Project Description</label>
                         <div class="mt-2">
                              <input type="text" on:input={ (event) => { validateForm("to-description", "to", "description", event) } } bind:value={ formFields.to.description } name="description" id="description" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                         </div>
                         <p class="text-red-500">{errors.to.description}</p>
                    </div>
                    ...
                    <div class="mt-5">
                         ...
                         <div class="mt-2 space-y-4">
                              {#each numberOfColumns as item, i}
                                   <div class="flex items-center space-x-4">
                                        <input type="text" on:input={ (event) => { validateForm("item-name", false, false, event) } } bind:value={ arrayOfItems[i].name } class="block w-full bg-transparent rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="e.g. ToDo">
                                        <input type="text" on:input={ (event) => { validateForm("item-qty", false, false, event) } } bind:value={ arrayOfItems[i].qty } class="block w-full bg-transparent rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="e.g. ToDo">
                                        <input type="text" on:input={ (event) => { validateForm("item-price", false, false, event) } } bind:value={ arrayOfItems[i].price } class="block w-full bg-transparent rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="e.g. ToDo">
                                        {#if i >= 1}
