...
<main class="px-6 w-full max-w-[45.625rem] mx-auto" style="height: 100vh; overflow-y: auto;">
     <a href="/" class="flex items-center font-bold text-15 text-[#0C0E16] dark:text-white my-8">
