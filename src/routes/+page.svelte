...
<div class="space-y-4">
     ...
     <input on:change={ test } id="filter-mobile-category-0" name="category[]" value="Paid" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
     <label for="filter-mobile-category-0" class="ml-3 text-sm text-gray-500">Paid</label>
     </div>
     <div class="flex items-center">
     <input on:change={ test } id="filter-mobile-category-1" name="category[]" value="Pending" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
     <label for="filter-mobile-category-1" class="ml-3 text-sm text-gray-500">Pending</label>
     </div>
     <div class="flex items-center">
     <input on:change={ test } id="filter-mobile-category-2" name="category[]" value="Draft" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
